  ...
  return (
    <header className="flex items-center justify-between px-4 lg:px-8 py-4 border-b border-[var(--border-subtle)]">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 px-3 py-2 text-xs text-white rounded-lg font-medium bg-gradient-to-r from-indigo-600 to-indigo-500 hover:shadow-[0_0_20px_rgba(99,102,241,0.3)] transition-shadow">
          <Plus size={14} />
